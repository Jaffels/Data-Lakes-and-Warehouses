...
# --process_date       2025-12-08
# --conf               spark.rpc.message.maxSize=512        ← ADD THIS
# --conf               spark.kryoserializer.buffer.max=512m ← ADD THIS
# --conf               spark.sql.shuffle.partitions=200     ← ADD THIS